    ...
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Map Placeholder */}
          <div className="aspect-[4/3] lg:aspect-auto lg:min-h-[400px] bg-gray-100 rounded-2xl overflow-hidden flex items-center justify-center">
            {/* 실제 지도가 들어갈 자리 - 카카오맵 또는 네이버맵 iframe */}
            <div className="text-center p-8">
              ...
              <p className="text-gray-500 text-sm mt-1">카카오맵 또는 네이버맵 삽입</p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center">
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@oasis-space.com" className="text-blue-600 hover:underline">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 border border-gray-300 text-gray-700 px-6 py-3 rounded-full font-semibold hover:bg-gray-50 transition-colors"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
